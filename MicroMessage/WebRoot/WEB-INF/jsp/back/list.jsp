...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="${pageContext.request.contextPath }/resources/back/js/list.js"></script>
	</head>
	<body style="background: #e1e9eb;">
		<form action="<%=basePath %>/listServlet" id="mainForm" method="post">
			<div class="right">
				...
				<div class="rightCont">
					<p class="g_title fix">内容列表 <a class="btn03" href="<%=basePath %>resources/jsp/add.jsp">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn03" href="javascript:DeleteBatch('<%=basePath%>');">删 除</a></p>
					<table class="tab1">
						<tbody>
							<tr>
